...
func newLike(db *gorm.DB, opts ...gen.DOOption) like {
	...
	_like.likeDo.UseModel(&orm_gen.Like{})
	...
	_like.Cancel = field.NewInt64(tableName, "cancel")
...
func (l *like) updateTableName(table string) *like {
	...
	l.Cancel = field.NewInt64(table, "cancel")
...
type ILikeDo interface {
	...
	Unscoped() ILikeDo
	Create(values ...*orm_gen.Like) error
	CreateInBatches(values []*orm_gen.Like, batchSize int) error
	Save(values ...*orm_gen.Like) error
	First() (*orm_gen.Like, error)
	Take() (*orm_gen.Like, error)
	Last() (*orm_gen.Like, error)
	Find() ([]*orm_gen.Like, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*orm_gen.Like, err error)
	FindInBatches(result *[]*orm_gen.Like, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*orm_gen.Like) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*orm_gen.Like, error)
	FirstOrCreate() (*orm_gen.Like, error)
	FindByPage(offset int, limit int) (result []*orm_gen.Like, count int64, err error)
...
func (l likeDo) Create(values ...*orm_gen.Like) error {
	if len(values) == 0 {
		return nil
	}
...
func (l likeDo) CreateInBatches(values []*orm_gen.Like, batchSize int) error {
	return l.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (l likeDo) Save(values ...*orm_gen.Like) error {
	if len(values) == 0 {
		return nil
	}
...
func (l likeDo) First() (*orm_gen.Like, error) {
	if result, err := l.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*orm_gen.Like), nil
	}
}

func (l likeDo) Take() (*orm_gen.Like, error) {
...
func (l likeDo) Last() (*orm_gen.Like, error) {
...
func (l likeDo) Find() ([]*orm_gen.Like, error) {
	result, err := l.DO.Find()
	return result.([]*orm_gen.Like), err
}

func (l likeDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*orm_gen.Like, err error) {
	buf := make([]*orm_gen.Like, 0, batchSize)
...
func (l likeDo) FindInBatches(result *[]*orm_gen.Like, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (l likeDo) FirstOrInit() (*orm_gen.Like, error) {
...
func (l likeDo) FirstOrCreate() (*orm_gen.Like, error) {
...
func (l likeDo) FindByPage(offset int, limit int) (result []*orm_gen.Like, count int64, err error) {
...
func (l likeDo) Delete(models ...*orm_gen.Like) (result gen.ResultInfo, err error) {
