...
func newVideo(db *gorm.DB, opts ...gen.DOOption) video {
	...
	_video.videoDo.UseModel(&orm_gen.Video{})
...
type IVideoDo interface {
	...
	Unscoped() IVideoDo
	Create(values ...*orm_gen.Video) error
	CreateInBatches(values []*orm_gen.Video, batchSize int) error
	Save(values ...*orm_gen.Video) error
	First() (*orm_gen.Video, error)
	Take() (*orm_gen.Video, error)
	Last() (*orm_gen.Video, error)
	Find() ([]*orm_gen.Video, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*orm_gen.Video, err error)
	FindInBatches(result *[]*orm_gen.Video, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*orm_gen.Video) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*orm_gen.Video, error)
	FirstOrCreate() (*orm_gen.Video, error)
	FindByPage(offset int, limit int) (result []*orm_gen.Video, count int64, err error)
...
func (v videoDo) Create(values ...*orm_gen.Video) error {
	if len(values) == 0 {
		return nil
	}
...
func (v videoDo) CreateInBatches(values []*orm_gen.Video, batchSize int) error {
	return v.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (v videoDo) Save(values ...*orm_gen.Video) error {
	if len(values) == 0 {
		return nil
	}
...
func (v videoDo) First() (*orm_gen.Video, error) {
	if result, err := v.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*orm_gen.Video), nil
	}
}

func (v videoDo) Take() (*orm_gen.Video, error) {
...
func (v videoDo) Last() (*orm_gen.Video, error) {
...
func (v videoDo) Find() ([]*orm_gen.Video, error) {
	result, err := v.DO.Find()
	return result.([]*orm_gen.Video), err
}

func (v videoDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*orm_gen.Video, err error) {
	buf := make([]*orm_gen.Video, 0, batchSize)
...
func (v videoDo) FindInBatches(result *[]*orm_gen.Video, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (v videoDo) FirstOrInit() (*orm_gen.Video, error) {
...
func (v videoDo) FirstOrCreate() (*orm_gen.Video, error) {
...
func (v videoDo) FindByPage(offset int, limit int) (result []*orm_gen.Video, count int64, err error) {
...
func (v videoDo) Delete(models ...*orm_gen.Video) (result gen.ResultInfo, err error) {
